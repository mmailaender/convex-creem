...
export type ConnectedBillingApi = {
  ...
  /** Optional app-owned free plan activation mutation. */
  plans?: {
...
export type ConnectedBillingModel = {
   ...
   * `undefined` preserves the default widget behavior of treating the first free plan as active for signed-in users without a paid subscription.
